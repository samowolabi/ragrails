...
from utils.resource_monitor import snapshot
from utils.report import print_report
from utils.frontmatter import build as build_frontmatter
...
async def _crawl_site(
    ...
    async for result in stream:
        ...
        # e.g. https://opencode.ai/docs/agents/ and https://opencode.ai/docs/agents → same page
