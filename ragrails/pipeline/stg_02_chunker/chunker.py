...
from ragrails.utils.frontmatter import parse as parse_frontmatter
...
def chunk_dir(config: ChunkerConfig | None = None) -> dict:
    ...
    if not md_files:
        ...
        return {"files": 0, "chunks": 0, "output_files": [], "failed": 0, "errors": []}
