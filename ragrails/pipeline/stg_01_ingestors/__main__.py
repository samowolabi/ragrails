"""
Run:
    uv run python -m ragrails.pipeline.stg_01_ingestors url    # BFS-crawl a website and save as markdown
    uv run python -m ragrails.pipeline.stg_01_ingestors api    # fetch a REST API and save as markdown
    uv run python -m ragrails.pipeline.stg_01_ingestors docs   # convert local files (PDF, CSV, etc.) to markdown
"""
