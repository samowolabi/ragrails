...
def embed_chunks(
    ...
    Args:
        ...
        store:   VectorStore instance created by the vector DB registry.
    ...
    Example:
        ...
        # → embeds all files in files/output/chunks and upserts into the configured store
    """
    ...
    if not paths:
        ...
        return {
            ...
            "errors": [f"No chunk files found in {cfg.input_dir}"],
        }
