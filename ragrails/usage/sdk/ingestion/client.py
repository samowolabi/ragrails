...
from ragrails.usage.sdk.shared import missing_extra, run_async
    ...
    def _normalize_docs(files: str | list[str | dict]) -> list[dict]:
        ...
        for item in file_list:
            if isinstance(item, str):
                ...
                IngestionMixin._validate_document_extension(item)
                ...
                IngestionMixin._validate_document_extension(filename)
