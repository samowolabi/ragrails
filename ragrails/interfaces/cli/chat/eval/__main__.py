...
Examples:
    uv run python -m ragrails.interfaces.cli.chat.eval
    uv run python -m ragrails.interfaces.cli.chat.eval --golden files/eval/rag_golden.jsonl
    uv run python -m ragrails.interfaces.cli.chat.eval --retrieval-only
    uv run python -m ragrails.interfaces.cli.chat.eval --judge
    uv run python -m ragrails.interfaces.cli.chat.eval \
...
from ragrails.core.stg_05_retriever.query_rewriter import rewrite
from ragrails.core.stg_05_retriever.retriever import rerank, retrieve
from ragrails.core.stg_06_chat.config import ChatConfig
from ragrails.interfaces.cli.chat.generator import generate
