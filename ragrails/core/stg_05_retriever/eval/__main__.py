"""
Run:
    uv run python -m ragrails.core.stg_05_retriever.eval                  # eval 10 auto-generated queries
    uv run python -m ragrails.core.stg_05_retriever.eval <n>              # eval n auto-generated queries
    uv run python -m ragrails.core.stg_05_retriever.eval query "<query>"  # eval a single query directly
"""
...
if mode == "query":
    if len(sys.argv) < 3:
        print("Usage: uv run python -m ragrails.core.stg_05_retriever.eval query \"<query>\"")
        sys.exit(1)
