"""
Run:
    uv run python -m ragrails.core.stg_01_ingestors url    # crawl a website and return markdown
    uv run python -m ragrails.core.stg_01_ingestors api    # fetch a REST API and return markdown
    uv run python -m ragrails.core.stg_01_ingestors docs   # convert local files (PDF, CSV, etc.) to markdown
"""
