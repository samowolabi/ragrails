...
These docs are organized by usage surface. Each usage surface has the same
pipeline stage shape.

| Usage | Overview | Ingestion | Chunking | Embedding | Storing | Retrieval |
|---|---|---|---|---|---|---|
| SDK | [SDK](sdk/README.md) | [Ingestion](sdk/ingestion/README.md) | [Chunking](sdk/chunking/README.md) | [Embedding](sdk/embedding/README.md) | [Storing](sdk/storing/README.md) | [Retrieval](sdk/retrieval/README.md) |
